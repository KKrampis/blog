...
* *https://www.aisafety.camp/#h.t14iaqf5qbl7[AI Safety Camp]* mentor/project lead for Fall 2025, "AutoCircuit: Automated Discovery of Interpretable Reasoning Patterns in LLMs"
...
* *BlueDot Impact https://bluedot.org/courses/technical-ai-safety[Technical AI Safety]* Winter 2026 cohort (pending application)

== AI/ML Research and Teaching Highlights

* *Transcriptomics: AI for Genome Analysis*, new course to start in Spring 2026 with a focus on LLMs trained with genomic data, https://kkrampis.github.io/blog/teaching/genomeai/index.html[syllabus available]
...
* https://github.com/KKrampis/autocircuit[AutoCircuit]: Automated Discovery of Interpretable Reasoning Patterns in Large Language Models
* https://github.com/KKrampis/GraphML-Bioinformatics-Course/tree/main/BioinformAI[Python Jupyter notebooks] for teaching machine learning for biological network data (graph deep neural networks)
* https://github.com/KKrampis/Bioinform-Geometric-ML-Paper[Github repository] for paper published on geometric and graph deep learning, reviewing ML applications for bioinformatics
* https://www.jcvi.org/research/jcvi-cloud-biolinux[Cloud BioLinux co-founder], first Linux for bioinformatics on the Amazon cloud (Krampis et al. 2012)
...
* Madupu R, Rogers Yu-H, Rusch D, Miller J, Krampis K and Nelson KE. (2012) "Microbiomes", in _Encyclopedia of Molecular Cell Biology and Molecular Medicine_, published by Wiley-VCH Verlag GmbH Germany.
* Miller J, Rusch D, Krampis K, Tovichgrechko A, Sutton G, Yooseph S and Nelson KE. (2012) "Bioinformatics for Genomes and Metagenomes in Microbial Ecology Studies", in _Infectious Micro-ecology: Theory and Applications_, published by Wiley-VCH Verlag GmbH & Co., Germany.
* Tyler BM, Jiang RHY, Zhou L, Tripathy S, Dou D, Torto-Alalibo T, Li H, Mao Y, Liu B, Vega-Sanchez M, Mideros SX, Hanlon R, Smith, BM, Krampis K et al. (2008) "Functional genomics and bioinformatics of the Phytophthora sojae soybean interaction", in _Genomics of Disease_, published by Springer Science, New York, USA.
